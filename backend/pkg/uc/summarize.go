...
<instruction>
    <instructions>
        ...
        3. 文脈全体の本質を捉えつつ、本質を失わないように簡潔な要約を書きます。
...
`,
			...
			{
				Role:    "user",
				Content: "プロフェッショナルとして" + target + "を自然な日本語50〜100語で簡潔に要約してください。以下の例に従って、提供された内容を要約してください。要約は50〜100語の範囲内で、明確で理解しやすいものである必要があります。技術的な詳細を簡潔にまとめ、一般の読者にも理解しやすいようにしてください。",
			},
		},
	})
	if err != nil {
